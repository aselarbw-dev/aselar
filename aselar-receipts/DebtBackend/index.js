...
// Routes
const debt=require("./routes/debt.js")
const smsDebt=require("./routes/sms.js")
app.use('/api',debt)
app.use('/api',smsDebt)
// Health check route
...
const startServer = async () => {
  try {
    ...
    // Step 2: Connect DB for debt Service local models if needed
    if (!isConnected()) {
    ...
    console.error('❌ Failed to start debt Service:', error);
    process.exit(1);
  }
};
