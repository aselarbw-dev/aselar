...
import styles from './QuoteWhatsAppModal.module.css'
interface WhatsAppModalProps{
    isOpen:boolean,
    onClose:()=>void,
    onSubmit:(whatsappNumber:string)=>void
}
const QuoteWhatsAppModal:React.FC<WhatsAppModalProps> = ({isOpen,onClose,onSubmit}) => {
...
export default QuoteWhatsAppModal
